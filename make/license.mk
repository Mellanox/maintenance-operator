...
COPYRIGHT_FLAGS         ?= -s
COPYRIGHT_EXCLUDE       ?= vendor deployment config bundle bundle.Dockerfile .*
...
third-party-licenses: go-licenses
	...
	@GOROOT=$(shell go env GOROOT)  $(GO_LICENSES) save ./... --save_path=third_party_licenses --ignore=golang.org/x/sys/unix --ignore=github.com/cespare/xxhash/v2 --ignore github.com/Mellanox/maintenance-operator/api/v1alpha1
